...
## 👨‍💻 Sobre Mim
Com mais de 30 anos de jornada em TI (Infra, Dev e Segurança) e Comunicação, atuo hoje na vanguarda da automação e governança de ambientes críticos. Minha missão é traduzir tecnologia em resultados, unindo a robustez do mundo corporativo com a agilidade de soluções modernas de infraestrutura como código.

### Atualmente, foco em:
- 🚀 **Automação & Governança:** Especialista em ecossistema Microsoft 365, PowerShell e Microsoft Graph.
- 🛠️ **Cultura Maker:** Design e fabricação digital (Impressão 3D FDM) para soluções de hardware.
- 🏠 **Smart Home & IoT:** Implementação e troubleshooting de ecossistemas via Home Assistant e Zigbee.
